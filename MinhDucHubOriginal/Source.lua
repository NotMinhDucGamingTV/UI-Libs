	...
	function functions:Tabs(TabsName:string,Icon:string)
		...
		Button_3.MouseButton1Click:Connect(function()
			...
			elseif CurrentTab ~= nil and CurrentTab ~= "Tweening" and CurrentTab ~= TitleName then
				...
				local tween2 = game:GetService("TweenService"):Create(home,TweenInfo.new(.15,Enum.EasingStyle.Linear),{ImageColor3 = Color3.fromRGB(255,255,255)})
				local tween3 = game:GetService("TweenService"):Create(Home,TweenInfo.new(.15,Enum.EasingStyle.Linear),{BorderSizePixel = 1})
				local tween4 = game:GetService("TweenService"):Create(CurrentTabLabel:WaitForChild("Title"),TweenInfo.new(.15,Enum.EasingStyle.Linear),{TextColor3 = Color3.fromRGB(129,129,129)})
				local tween5 = game:GetService("TweenService"):Create(CurrentTabLabel:WaitForChild("home"),TweenInfo.new(.15,Enum.EasingStyle.Linear),{ImageColor3 = Color3.fromRGB(104,104,104)})
